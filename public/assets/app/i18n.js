...
export const I18N = {
  en: {
    ...
    whatsNew: "What's new",
    whatsNewBody:
      "3.2.0 Local Pulse: on-device diagnostics for cache, version, and camera permission. Shared Reality still signals across phones through xray-signal.jonbailey.xyz (SDP and ICE only, 2 hour TTL, never camera). Camera frames stay on this device.",
